        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <AnimateOnScroll key={project.title}>
              <div className="gradient-border hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <div className="inner !p-0">
                  ...
                  <div className="p-6 space-y-4">
                    <h3 className="text-xl font-semibold text-foreground hover:gradient-text transition-all duration-300">
                      {project.title}
                    </h3>
                    ...
                    <div className="flex gap-3 pt-2">
                      <Button 
                        variant="outline" 
                        size="sm"
                        className="flex-1 hover:bg-gradient-to-r hover:from-[#00dbde] hover:to-[#fc00ff] hover:text-white transition-all"
                        asChild
                      >
                      ...
                      <Button 
                        size="sm"
                        className="flex-1 bg-gradient-to-r from-[#00dbde] to-[#fc00ff] hover:opacity-90 transition-opacity"
                        asChild
                      >
